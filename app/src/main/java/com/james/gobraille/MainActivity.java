...
import com.james.gobraille.Util.UploadImageUtil;
import com.james.gobraille.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mBinding == null){
            Log.d(Constants.TAG, "mBinding is null");
        }
        else {
            Log.d(Constants.TAG, "Its not ");
        }
